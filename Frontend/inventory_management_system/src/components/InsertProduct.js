    ...
    return (
        <div className='container-fluid p-5'>
            ...
            <div className='d-flex justify-content-center col-lg-6 col-md-6'>
                ...
                <button type="submit" style={{ backgroundColor: '#937c91', color: '#fff',fontWeight: 'bold' }} onClick={addProduct} className="btn btn-primary fs-4" disabled={loading}>{loading ? 'Inserting...' : 'Insert'}</button>
            </div>
