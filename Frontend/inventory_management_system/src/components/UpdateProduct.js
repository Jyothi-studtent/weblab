    ...
    return (
        <div className='container-fluid p-5'>
            ...
            <div className='d-flex justify-content-center col-lg-6 col-md-6'>
                <NavLink to="/products" className='btn btn-primary me-5 fs-4' style={{ backgroundColor: '#937c91', color: '#fff',fontWeight: 'bold' }}>Cancel</NavLink>
                <button type="submit" style={{ backgroundColor: '#937c91', color: '#fff',fontWeight: 'bold' }} onClick={updateProduct} className="btn btn-primary fs-4" disabled={loading}>{loading ? 'Updating...' : 'Update'}</button>
            </div>
